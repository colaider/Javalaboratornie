...
public class WriterTest extends TestCase {
    ...
    public void testWriteToFile() {
        ...
        try{
            ...
            final Scanner checkFile = new Scanner(new File("/Users/sasaminaev/Desktop/codits/java/Labs/lab_3 копія 2/work/result.csv"));
            final Scanner exampleFile = new Scanner(new File("/Users/sasaminaev/Desktop/codits/java/Labs/lab_3 копія 2/work/example.csv"));
